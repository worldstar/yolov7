    ...
    def __call__(self, p, targets):  # predictions, targets, model
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                iou, _ = bbox_iou(pbox.T, tbox[i], x1y1x2y2=False, KFIoU=True)  # iou(prediction, target)
    ...
    def __call__(self, p, targets, imgs):  # predictions, targets, model   
        ...
        for i, pi in enumerate(p):  # layer index, layer predictions
            ...
            if n:
                ...
                iou, _ = bbox_iou(pbox.T, selected_tbox, x1y1x2y2=False, KFIoU=True)  # iou(prediction, target)
                lbox += (1.0 - iou).mean()  # iou loss
    ...
    def __call__(self, p, targets, imgs):  # predictions, targets, model   
        ...
        for i in range(self.nl):  # layer index, layer predictions
            ...
            if n_aux:
                ...
                iou_aux, _ = bbox_iou(pbox_aux.T, selected_tbox_aux, x1y1x2y2=False, KFIoU=True)  # iou(prediction, target)
